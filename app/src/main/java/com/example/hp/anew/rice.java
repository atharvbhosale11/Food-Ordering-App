    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.inc1:
                ...
                caart c=new caart("Plain Rice",k1,35);
                if(user != null)
                {
                    if(k1==1)
                    {
            ...
            case R.id.inc2:
                ...
                caart c2=new caart("Jeera Rice",k2,50);
                if(user != null)
                {
                    if(k2==1)
                    {
            ...
            case R.id.inc3:
                ...
                caart c3=new caart("Khichdi",k3,60);
                if(user != null)
                {
                    if(k3==1)
                    {
            ...
            case R.id.inc4:
                ...
                caart c4=new caart("Curd Rice",k4,55);
                if(user != null)
                {
                    if(k4==1)
                    {
            ...
            case R.id.dec1:
                ...
                l1--;
                caart c5=new caart("Plain Rice",l1,35);
                if(l1<=0)
                {
                    q1.setText("0");
            ...
            case R.id.dec2:
                ...
                l2--;
                caart c6=new caart("Jeera Rice",l2,50);
                if(l2<=0)
                {
                    q2.setText("0");
            ...
            case R.id.dec3:
                ...
                l3--;
                caart c7=new caart("Khichdi",l3,60);
                if(l3<=0)
                {
                    q3.setText("0");
            ...
            case R.id.dec4:
                ...
                l4--;
                caart c8=new caart("Curd Rice",l4,55);
                if(l4<=0)
                {
                    q4.setText("0");
