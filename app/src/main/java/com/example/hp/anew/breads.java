    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            ...
            case R.id.inc2:
                ...
                caart c2=new caart("Chapati",k2,15);
                if(user != null)
                {
                    if(k2==1)
                    {
            ...
            case R.id.inc3:
                ...
                caart c3=new caart("Butter Nan",k3,25);
                if(user != null)
                {
                    if(k3==1)
                    {
            ...
            case R.id.inc4:
                ...
                caart c4=new caart("Garlic Nan",k4,40);
                if(user != null)
                {
                    if(k4==1)
                    {
            ...
            case R.id.dec2:
                ...
                l2--;
                caart c6=new caart("Chapati",l2,15);
                if(l2<=0)
                {
                    q2.setText("0");
            ...
            case R.id.dec3:
                ...
                l3--;
                caart c7=new caart("Butter Nan",l3,25);
                if(l3<=0)
                {
                    q3.setText("0");
            ...
            case R.id.dec4:
                ...
                l4--;
                caart c8=new caart("Garlic Nan",l4,40);
                if(l4<=0)
                {
                    q4.setText("0");
